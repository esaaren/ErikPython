...
if __name__ == "__main__":
    ...
    df = HiveContext(sc).sql("select raw_text from erik.erik_poc")
    ...
    print ("Creating word2vec model, vector size 50")
    word2vec = Word2Vec(vectorSize=50, minCount=0, inputCol="text_words", outputCol="result")
    ...
    print ("Creating globalView : vectors")
    model.getVectors().createGlobalTempView("vectors")
    ...
    synonyms = model.findSynonyms('put a word here', 5)
    synonyms.show()
